...
<form action="<?php echo esc_url(home_url('/')); ?>" class="u-border-1 u-border-grey-30 u-search u-search-left u-white u-search-1" method="">
      ...
      <input class="u-custom-font u-font-montserrat u-search-input" type="search" name="s" value="<?php echo get_search_query(); ?>" placeholder="<?php _e(sprintf(__('Search'))); ?>">
    </form>